...
import { idlFactory } from './studentWall_backend.did.js';
export { idlFactory } from './studentWall_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.STUDENTWALL_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./studentWall_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the studentWall_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./studentWall_backend.did.js")._SERVICE>}
 */
export const studentWall_backend = createActor(canisterId);
