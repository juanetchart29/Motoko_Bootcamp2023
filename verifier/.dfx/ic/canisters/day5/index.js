...
import { idlFactory } from './day5.did.js';
export { idlFactory } from './day5.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAY5_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./day5.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the day5 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./day5.did.js")._SERVICE>}
 */
export const day5 = createActor(canisterId);
